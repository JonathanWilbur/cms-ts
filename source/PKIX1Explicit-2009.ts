...
export function _encode_RelativeDistinguishedName(
    ...
    if (!_cached_encoder_for_RelativeDistinguishedName) {
        _cached_encoder_for_RelativeDistinguishedName = __utils._encodeSetOf<
            SingleAttribute
        >(() => _encode_SingleAttribute, __utils.BER);
    }
...
export function _get_decoder_for_SIGNED<ToBeSigned>(
    ...
    return function (el: asn1.ASN1Element): SIGNED<ToBeSigned> {
        ...
        algorithmIdentifier = _decode_AlgorithmIdentifier(sequence[1]);
        ...
        _cached_decoder_for_TBSCertificate = function (
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                issuerUniqueID: (_el: asn1.ASN1Element): void => {
                    issuerUniqueID = __utils._decode_explicit<UniqueIdentifier>(
                        () => _decode_UniqueIdentifier
                    )(_el);
                },
                subjectUniqueID: (_el: asn1.ASN1Element): void => {
                    subjectUniqueID = __utils._decode_explicit<
                        UniqueIdentifier
                        ...
                        [
                            /* IF_ABSENT  */ value.issuerUniqueID === undefined
                                ...
                                : __utils._encode_explicit(
                                      ...
                                      __utils.BER
                                  )(value.issuerUniqueID, __utils.BER),
                            /* IF_ABSENT  */ value.subjectUniqueID === undefined
                                ? undefined
                                : __utils._encode_explicit(
                                      asn1.ASN1TagClass.context,
                                      2,
                                      () => _encode_UniqueIdentifier,
                                      __utils.BER
                                  )(value.subjectUniqueID, __utils.BER),
...
let _cached_decoder_for_TBSCertList_revokedCertificates_Item: __utils.ASN1Decoder<
    TBSCertList_revokedCertificates_Item
> | null = null;
let _cached_encoder_for_TBSCertList_revokedCertificates_Item: __utils.ASN1Encoder<
    TBSCertList_revokedCertificates_Item
> | null = null;
export function _decode_TBSCertList_revokedCertificates_Item(
    el: asn1.ASN1Element
) {
    if (!_cached_decoder_for_TBSCertList_revokedCertificates_Item) {
        _cached_decoder_for_TBSCertList_revokedCertificates_Item = function (
            el: asn1.ASN1Element
        ): TBSCertList_revokedCertificates_Item {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            const callbacks: __utils.DecodingMap = {
                userCertificate: (_el: asn1.ASN1Element): void => {
                    userCertificate = _decode_CertificateSerialNumber(_el);
                },
...
export function _encode_TBSCertList_revokedCertificates_Item(
    value: TBSCertList_revokedCertificates_Item,
    elGetter: __utils.ASN1Encoder<TBSCertList_revokedCertificates_Item>
) {
    if (!_cached_encoder_for_TBSCertList_revokedCertificates_Item) {
        _cached_encoder_for_TBSCertList_revokedCertificates_Item = function (
            value: TBSCertList_revokedCertificates_Item,
            elGetter: __utils.ASN1Encoder<TBSCertList_revokedCertificates_Item>
        ): asn1.ASN1Element {
            return __utils._encodeSequence(
    ...
    return _cached_encoder_for_TBSCertList_revokedCertificates_Item(
        value,
        elGetter
    );
}
...
export class TBSCertList {
    constructor(
        ...
        readonly revokedCertificates: asn1.OPTIONAL<
            TBSCertList_revokedCertificates_Item[]
        >,
...
let _cached_decoder_for_TBSCertList: __utils.ASN1Decoder<
    TBSCertList
> | null = null;
let _cached_encoder_for_TBSCertList: __utils.ASN1Encoder<
    TBSCertList
> | null = null;
export function _decode_TBSCertList(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_TBSCertList) {
        _cached_decoder_for_TBSCertList = function (
            el: asn1.ASN1Element
        ): TBSCertList {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let version: asn1.OPTIONAL<Version>;
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                revokedCertificates: (_el: asn1.ASN1Element): void => {
                    revokedCertificates = __utils._decodeSequenceOf<
                        TBSCertList_revokedCertificates_Item
                    >(() => _decode_TBSCertList_revokedCertificates_Item)(_el);
                },
...
export function _encode_TBSCertList(
    value: TBSCertList,
    elGetter: __utils.ASN1Encoder<TBSCertList>
) {
    if (!_cached_encoder_for_TBSCertList) {
        _cached_encoder_for_TBSCertList = function (
            value: TBSCertList,
            elGetter: __utils.ASN1Encoder<TBSCertList>
        ): asn1.ASN1Element {
            return __utils._encodeSequence(
                        ...
                        [
                            ...
                            undefined
                                ...
                                : __utils._encodeSequenceOf<
                                  ...
                                  >(
                                      () =>
                                          _encode_TBSCertList_revokedCertificates_Item,
                                      __utils.BER
