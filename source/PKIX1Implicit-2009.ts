        ...
        _cached_decoder_for_EDIPartyName = function (
            ...
            const callbacks: __utils.DecodingMap = {
                nameAssigner: (_el: asn1.ASN1Element): void => {
                    nameAssigner = __utils._decode_implicit<DirectoryString>(
                        () => _decode_DirectoryString
                    )(_el);
                },
                partyName: (_el: asn1.ASN1Element): void => {
                    partyName = __utils._decode_implicit<DirectoryString>(
                        () => _decode_DirectoryString
                    )(_el);
                },
            };
...
export function _decode_GeneralName(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_GeneralName) {
        _cached_decoder_for_GeneralName = __utils._decode_inextensible_choice<
            GeneralName
        >({
            "CONTEXT 0": [
                "otherName",
...
export class AuthorityKeyIdentifier {
    constructor(
        ...
        readonly authorityCertSerialNumber: asn1.OPTIONAL<
            CertificateSerialNumber
        >
    ) {}
}
        ...
        _cached_decoder_for_PolicyQualifierInfo = function (
            ...
            if (sequence.length < 2) {
                throw new asn1.ASN1ConstructionError(
                    "PolicyQualifierInfo contained only " +
...
let _cached_decoder_for_CertificatePolicies: __utils.ASN1Decoder<
    CertificatePolicies
> | null = null;
let _cached_encoder_for_CertificatePolicies: __utils.ASN1Encoder<
    CertificatePolicies
> | null = null;
export function _decode_CertificatePolicies(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertificatePolicies) {
        _cached_decoder_for_CertificatePolicies = __utils._decodeSequenceOf<
            PolicyInformation
        >(() => _decode_PolicyInformation);
    }
    return _cached_decoder_for_CertificatePolicies(el);
}
export function _encode_CertificatePolicies(
    value: CertificatePolicies,
    elGetter: __utils.ASN1Encoder<CertificatePolicies>
) {
    if (!_cached_encoder_for_CertificatePolicies) {
        _cached_encoder_for_CertificatePolicies = __utils._encodeSequenceOf<
            PolicyInformation
...
let _cached_decoder_for_PolicyMappings_Item: __utils.ASN1Decoder<
    PolicyMappings_Item
> | null = null;
let _cached_encoder_for_PolicyMappings_Item: __utils.ASN1Encoder<
    PolicyMappings_Item
> | null = null;
export function _decode_PolicyMappings_Item(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PolicyMappings_Item) {
        _cached_decoder_for_PolicyMappings_Item = function (
            el: asn1.ASN1Element
        ): PolicyMappings_Item {
            const sequence: asn1.ASN1Element[] = el.sequence;
            if (sequence.length < 2) {
                throw new asn1.ASN1ConstructionError(
                    "PolicyMappings-Item contained only " +
                        sequence.length.toString() +
                        " elements."
                );
            }
...
export function _encode_PolicyMappings_Item(
    value: PolicyMappings_Item,
    elGetter: __utils.ASN1Encoder<PolicyMappings_Item>
) {
    if (!_cached_encoder_for_PolicyMappings_Item) {
        _cached_encoder_for_PolicyMappings_Item = function (
            value: PolicyMappings_Item,
            elGetter: __utils.ASN1Encoder<PolicyMappings_Item>
        ): asn1.ASN1Element {
            return __utils._encodeSequence(
...
let _cached_decoder_for_PolicyMappings: __utils.ASN1Decoder<
    PolicyMappings
> | null = null;
let _cached_encoder_for_PolicyMappings: __utils.ASN1Encoder<
    PolicyMappings
> | null = null;
export function _decode_PolicyMappings(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PolicyMappings) {
        _cached_decoder_for_PolicyMappings = __utils._decodeSequenceOf<
            PolicyMappings_Item
        >(() => _decode_PolicyMappings_Item);
    }
    return _cached_decoder_for_PolicyMappings(el);
}
export function _encode_PolicyMappings(
    value: PolicyMappings,
    elGetter: __utils.ASN1Encoder<PolicyMappings>
) {
    if (!_cached_encoder_for_PolicyMappings) {
        _cached_encoder_for_PolicyMappings = __utils._encodeSequenceOf<
            PolicyMappings_Item
        >(() => _encode_PolicyMappings_Item, __utils.BER);
    }
...
let _cached_decoder_for_SubjectDirectoryAttributes: __utils.ASN1Decoder<
    SubjectDirectoryAttributes
> | null = null;
let _cached_encoder_for_SubjectDirectoryAttributes: __utils.ASN1Encoder<
    SubjectDirectoryAttributes
> | null = null;
export function _decode_SubjectDirectoryAttributes(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SubjectDirectoryAttributes) {
        _cached_decoder_for_SubjectDirectoryAttributes = __utils._decodeSequenceOf<
            AttributeSet
        >(() => _decode_AttributeSet);
    }
    return _cached_decoder_for_SubjectDirectoryAttributes(el);
}
export function _encode_SubjectDirectoryAttributes(
    value: SubjectDirectoryAttributes,
    elGetter: __utils.ASN1Encoder<SubjectDirectoryAttributes>
) {
    if (!_cached_encoder_for_SubjectDirectoryAttributes) {
        _cached_encoder_for_SubjectDirectoryAttributes = __utils._encodeSequenceOf<
            AttributeSet
...
let _cached_decoder_for_BasicConstraints: __utils.ASN1Decoder<
    BasicConstraints
> | null = null;
let _cached_encoder_for_BasicConstraints: __utils.ASN1Encoder<
    BasicConstraints
> | null = null;
export function _decode_BasicConstraints(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_BasicConstraints) {
        _cached_decoder_for_BasicConstraints = function (
            el: asn1.ASN1Element
        ): BasicConstraints {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let cA: asn1.OPTIONAL<asn1.BOOLEAN> =
                BasicConstraints._default_value_for_cA;
...
export function _encode_BasicConstraints(
    value: BasicConstraints,
    elGetter: __utils.ASN1Encoder<BasicConstraints>
) {
    if (!_cached_encoder_for_BasicConstraints) {
        _cached_encoder_for_BasicConstraints = function (
            value: BasicConstraints,
            elGetter: __utils.ASN1Encoder<BasicConstraints>
        ): asn1.ASN1Element {
            return __utils._encodeSequence(
...
let _cached_decoder_for_NameConstraints: __utils.ASN1Decoder<
    NameConstraints
> | null = null;
let _cached_encoder_for_NameConstraints: __utils.ASN1Encoder<
    NameConstraints
> | null = null;
export function _decode_NameConstraints(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_NameConstraints) {
        _cached_decoder_for_NameConstraints = function (
            el: asn1.ASN1Element
        ): NameConstraints {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_NameConstraints(
    value: NameConstraints,
    elGetter: __utils.ASN1Encoder<NameConstraints>
) {
    if (!_cached_encoder_for_NameConstraints) {
        _cached_encoder_for_NameConstraints = function (
            value: NameConstraints,
            elGetter: __utils.ASN1Encoder<NameConstraints>
        ): asn1.ASN1Element {
            return __utils._encodeSequence(
...
let _cached_decoder_for_PolicyConstraints: __utils.ASN1Decoder<
    PolicyConstraints
> | null = null;
let _cached_encoder_for_PolicyConstraints: __utils.ASN1Encoder<
    PolicyConstraints
> | null = null;
export function _decode_PolicyConstraints(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PolicyConstraints) {
        _cached_decoder_for_PolicyConstraints = function (
            el: asn1.ASN1Element
        ): PolicyConstraints {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export function _encode_PolicyConstraints(
    value: PolicyConstraints,
    elGetter: __utils.ASN1Encoder<PolicyConstraints>
) {
    if (!_cached_encoder_for_PolicyConstraints) {
        _cached_encoder_for_PolicyConstraints = function (
            value: PolicyConstraints,
            elGetter: __utils.ASN1Encoder<PolicyConstraints>
        ): asn1.ASN1Element {
            return __utils._encodeSequence(
...
export function _decode_DistributionPointName(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_DistributionPointName) {
        _cached_decoder_for_DistributionPointName = __utils._decode_inextensible_choice<
            DistributionPointName
        >({
            "CONTEXT 0": [
                "fullName",
...
let _cached_decoder_for_CRLDistributionPoints: __utils.ASN1Decoder<
    CRLDistributionPoints
> | null = null;
let _cached_encoder_for_CRLDistributionPoints: __utils.ASN1Encoder<
    CRLDistributionPoints
> | null = null;
export function _decode_CRLDistributionPoints(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CRLDistributionPoints) {
        _cached_decoder_for_CRLDistributionPoints = __utils._decodeSequenceOf<
            DistributionPoint
        >(() => _decode_DistributionPoint);
    }
    return _cached_decoder_for_CRLDistributionPoints(el);
}
export function _encode_CRLDistributionPoints(
    value: CRLDistributionPoints,
    elGetter: __utils.ASN1Encoder<CRLDistributionPoints>
) {
    if (!_cached_encoder_for_CRLDistributionPoints) {
        _cached_encoder_for_CRLDistributionPoints = __utils._encodeSequenceOf<
            DistributionPoint
...
let _cached_decoder_for_ExtKeyUsageSyntax: __utils.ASN1Decoder<
    ExtKeyUsageSyntax
> | null = null;
let _cached_encoder_for_ExtKeyUsageSyntax: __utils.ASN1Encoder<
    ExtKeyUsageSyntax
> | null = null;
export function _decode_ExtKeyUsageSyntax(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ExtKeyUsageSyntax) {
        _cached_decoder_for_ExtKeyUsageSyntax = __utils._decodeSequenceOf<
            KeyPurposeId
        >(() => _decode_KeyPurposeId);
    }
    return _cached_decoder_for_ExtKeyUsageSyntax(el);
}
export function _encode_ExtKeyUsageSyntax(
    value: ExtKeyUsageSyntax,
    elGetter: __utils.ASN1Encoder<ExtKeyUsageSyntax>
) {
    if (!_cached_encoder_for_ExtKeyUsageSyntax) {
        _cached_encoder_for_ExtKeyUsageSyntax = __utils._encodeSequenceOf<
            KeyPurposeId
        >(() => _encode_KeyPurposeId, __utils.BER);
    }
...
export class IssuingDistributionPoint {
    ...
    public static get _default_value_for_onlyContainsUserCerts() {
        return false;
    }
    ...
    public static get _default_value_for_onlyContainsAttributeCerts() {
        return false;
    }
}
...
let _cached_decoder_for_IssuingDistributionPoint: __utils.ASN1Decoder<
    IssuingDistributionPoint
> | null = null;
let _cached_encoder_for_IssuingDistributionPoint: __utils.ASN1Encoder<
    IssuingDistributionPoint
> | null = null;
export function _decode_IssuingDistributionPoint(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_IssuingDistributionPoint) {
        _cached_decoder_for_IssuingDistributionPoint = function (
            el: asn1.ASN1Element
        ): IssuingDistributionPoint {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            let distributionPoint: asn1.OPTIONAL<DistributionPointName>;
            let onlyContainsUserCerts: asn1.OPTIONAL<asn1.BOOLEAN> =
                IssuingDistributionPoint._default_value_for_onlyContainsUserCerts;
            let onlyContainsCACerts: asn1.OPTIONAL<asn1.BOOLEAN> =
                IssuingDistributionPoint._default_value_for_onlyContainsCACerts;
            let onlySomeReasons: asn1.OPTIONAL<ReasonFlags>;
            let indirectCRL: asn1.OPTIONAL<asn1.BOOLEAN> =
                IssuingDistributionPoint._default_value_for_indirectCRL;
            let onlyContainsAttributeCerts: asn1.OPTIONAL<asn1.BOOLEAN> =
                IssuingDistributionPoint._default_value_for_onlyContainsAttributeCerts;
            /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                distributionPoint: (_el: asn1.ASN1Element): void => {
                ...
                onlyContainsUserCerts: (_el: asn1.ASN1Element): void => {
                    onlyContainsUserCerts = __utils._decode_implicit<
                        asn1.BOOLEAN
...
export function _encode_IssuingDistributionPoint(
    value: IssuingDistributionPoint,
    elGetter: __utils.ASN1Encoder<IssuingDistributionPoint>
) {
    if (!_cached_encoder_for_IssuingDistributionPoint) {
        _cached_encoder_for_IssuingDistributionPoint = function (
            value: IssuingDistributionPoint,
            elGetter: __utils.ASN1Encoder<IssuingDistributionPoint>
        ): asn1.ASN1Element {
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        /* IF_DEFAULT */ value.onlyContainsUserCerts ===
                            undefined ||
                        __utils.deepEq(
                            value.onlyContainsUserCerts,
                            IssuingDistributionPoint._default_value_for_onlyContainsUserCerts
                        )
                            ? undefined
                            : __utils._encode_implicit(
                                  ...
                                  __utils.BER
                              )(value.onlyContainsUserCerts, __utils.BER),
                        ...
                        /* IF_DEFAULT */ value.onlyContainsAttributeCerts ===
                            undefined ||
                        __utils.deepEq(
...
export const CRLReason_unspecified: CRLReason =
    CRLReason.unspecified; /* LONG_NAMED_ENUMERATED_VALUE */
export const CRLReason_keyCompromise: CRLReason =
    CRLReason.keyCompromise; /* LONG_NAMED_ENUMERATED_VALUE */
export const CRLReason_cACompromise: CRLReason =
    CRLReason.cACompromise; /* LONG_NAMED_ENUMERATED_VALUE */
export const CRLReason_affiliationChanged: CRLReason =
    CRLReason.affiliationChanged; /* LONG_NAMED_ENUMERATED_VALUE */
export const CRLReason_superseded: CRLReason =
    CRLReason.superseded; /* LONG_NAMED_ENUMERATED_VALUE */
export const CRLReason_cessationOfOperation: CRLReason =
    CRLReason.cessationOfOperation; /* LONG_NAMED_ENUMERATED_VALUE */
export const CRLReason_certificateHold: CRLReason =
    CRLReason.certificateHold; /* LONG_NAMED_ENUMERATED_VALUE */
export const CRLReason_removeFromCRL: CRLReason =
    CRLReason.removeFromCRL; /* LONG_NAMED_ENUMERATED_VALUE */
export const CRLReason_privilegeWithdrawn: CRLReason =
    CRLReason.privilegeWithdrawn; /* LONG_NAMED_ENUMERATED_VALUE */
export const CRLReason_aACompromise: CRLReason =
    CRLReason.aACompromise; /* LONG_NAMED_ENUMERATED_VALUE */
